...
public abstract class PromptTextUI extends TextUI {
    ...
    public JTextComponent getPromptComponent(JTextComponent txt) {
        ...
        if(PromptSupport.getPromptFontStyle(txt) == null){
        	...
        	promptComponent.setFont(txt.getFont().deriveFont(PromptSupport.getPromptFontStyle(txt)));
        }
    ...
    /**
     * Delegates painting when {@link #shouldPaintPrompt(JTextComponent)} returns
     * false. Otherwise the prompt component is retrieved by calling
     * {@link #getPromptComponent(JTextComponent)} and painted. Then the caret of
     * the given text component is painted.
     */
